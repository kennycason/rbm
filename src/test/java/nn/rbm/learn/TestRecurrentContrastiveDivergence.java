...
public class TestRecurrentContrastiveDivergence {
    ...
    public void recurrentNumbers() {
        ...
        final RecurrentContrastiveDivergence recurrentContrastiveDivergence = new RecurrentContrastiveDivergence(new LearningParameters().setEpochs(1000).setLearningRate(0.75));
